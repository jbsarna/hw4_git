...
#### knn 5
```{r}
acs_knn5 <- knn(acsNorm_learn[,1:8], acsNorm_valid[,1:8], acsNorm_learn$HighIncome, k=20, prob = TRUE)
head(acs_knn5)
...
1) As I increase k the accuracy increases until I chose k = 50. I could continue to repeat this property or (loop) to find the best 
...
4) Based on the knn I created I would select knn5 - I read that for the number of observations around 1000 that ideally
  k = 20 (roughly). Not a hard and fast rule, but worth choosing based on the common standard.